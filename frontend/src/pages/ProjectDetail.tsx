...
export function ProjectDetail() {
  ...
  if (loading) {
    body = <p className="font-mono text-sm text-muted">Loading…</p>;
  } else if (error || !project) {
    body = <p className="text-sm text-remove">{error ?? "Project not found"}</p>;
  } else {
    body = (
      <>
  ...
  return <WorkspaceLayout>{body}</WorkspaceLayout>;
}
